...
root.iconbitmap(
    r"C:\Users\harritx9\OneDrive - Abbott\Documents\Python_3.10\Cards\Cards_GUI\Gaming-Cards.ico"
)
...
def fill_in_cards(cardImg):
    ...
    player_image1 = resize_card(
        f"C:\\Users\\harritx9\OneDrive - Abbott\\Documents\Python_3.10\\Cards\\Cards_GUI\\PNG-cards-1.3\\{cardImg[0]}.png"
    )
    player_label_1.config(image=player_image1, background="white")
    player_image2 = resize_card(
        f"C:\\Users\\harritx9\OneDrive - Abbott\\Documents\Python_3.10\\Cards\\Cards_GUI\\PNG-cards-1.3\\{cardImg[1]}.png"
    )
    player_label_2.config(image=player_image2, background="white")
    player_image3 = resize_card(
        f"C:\\Users\\harritx9\OneDrive - Abbott\\Documents\Python_3.10\\Cards\\Cards_GUI\\PNG-cards-1.3\\{cardImg[2]}.png"
    )
    player_label_3.config(image=player_image3, background="white")
    player_image4 = resize_card(
        f"C:\\Users\\harritx9\OneDrive - Abbott\\Documents\Python_3.10\\Cards\\Cards_GUI\\PNG-cards-1.3\\{cardImg[3]}.png"
    )
    player_label_4.config(image=player_image4, background="white")
    player_image5 = resize_card(
        f"C:\\Users\\harritx9\OneDrive - Abbott\\Documents\Python_3.10\\Cards\\Cards_GUI\\PNG-cards-1.3\\{cardImg[4]}.png"
    )
