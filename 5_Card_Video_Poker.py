...
def card_select(state: bool, state_s: str):
    global state_label_map, state1, state2, state3, state4, state5

    if state == False:
        state_label_map[state_s].config(background="#EF130D")
        state = True
        if state_s == "state1":
            state1 = True
        elif state_s == "state2":
        ...
        state_label_map[state_s].config(background="white")
        state = False
        if state_s == "state1":
            state1 = False
        elif state_s == "state2":
...
player_label_1 = Button(
    ...
    text="",
    background="white",
    command=lambda: card_select(state1, "state1"),
    borderwidth="6",
)
...
player_label_2 = Button(
    ...
    text="",
    background="white",
    command=lambda: card_select(state2, "state2"),
    borderwidth="6",
)
...
player_label_3 = Button(
    ...
    text="",
    background="white",
    command=lambda: card_select(state3, "state3"),
    borderwidth="6",
)
...
player_label_4 = Button(
    ...
    text="",
    background="white",
    command=lambda: card_select(state4, "state4"),
    borderwidth="6",
)
...
player_label_5 = Button(
    ...
    text="",
    background="white",
    command=lambda: card_select(state5, "state5"),
    borderwidth="6",
)
...
state_label_map = {
    "state1": player_label_1,
    "state2": player_label_2,
    "state3": player_label_3,
    "state4": player_label_4,
    "state5": player_label_5,
}
